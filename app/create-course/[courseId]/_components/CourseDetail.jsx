        ...
        <div className='border p-6 rounded-xl shadow-sm mt-3'>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-5'>
                <div className='flex gap-2'>
                    <HiOutlineChartBar className='text-4xl text-[#875bf9]'/>
                    <div>
                 ...
                 <div className='flex gap-2'>
                    <HiOutlineClock className='text-4xl text-[#875bf9]'/>
                    <div>
                 ...
                 <div className='flex gap-2'>
                    <HiOutlineBookOpen  className='text-4xl text-[#875bf9]'/>
                    <div>
                 ...
                 <div className='flex gap-2'>
                    <HiOutlinePlayCircle className='text-4xl text-[#875bf9]'/>
                    <div>
