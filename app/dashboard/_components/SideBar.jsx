    ...
    <div className = "fixed h-full md:w-64 p-5 shadow-md">
        ...
        <ul> 
            {menuItems.map((item,index) => (
                ...
                <div className={`flex items-center gap-2 text-gray-600 p-3 hover:bg-gray-100 hover:text-black rounded-lg mb-3
         ...
         <div className = "absolute bottom-10 w-[80%]"> 
            ...
            <h2 className ="text-xs text-gray-500"> Upgrade your plan for more access</h2>
         </div>
    </div>
  )
}
